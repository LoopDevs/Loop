...
| `src/currencies.ts` | `HOME_CURRENCIES`, `HomeCurrency`, `isHomeCurrency()` — three-currency enum backing `users.home_currency` CHECK (ADR 015); also the onboarding picker list                                                 |
