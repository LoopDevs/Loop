...
| `src/cashback.ts`  | `applyCashbackPct`, `splitCashbackFaceValue`, `FALLBACK_CASHBACK_SPLIT`, `CashbackSplit` — pure bigint math shared by backend order creation + web cashback previews (ADR 011 / 015)                       |
