...
| `src/public.ts`    | `PublicCashbackStats`, `PublicTopCashbackMerchant`, `PublicTopCashbackMerchantsResponse` — wire contract for unauthenticated `/api/public/*` endpoints (ADR 011 / 015)                                     |
