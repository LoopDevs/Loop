...
| `src/stellar.ts`   | `STELLAR_PUBKEY_REGEX`, `isValidStellarAddress()` — Stellar ED25519 pubkey validator (ADR 015); used by backend's set-address handler + web wallet-linking form                                            |
