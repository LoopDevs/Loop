...
| `src/credit-transactions.ts` | `CREDIT_TRANSACTION_TYPES`, `CreditTransactionType`, `isCreditTransactionType()`, `expectedCreditAmountSign()` — mirrors the `credit_transactions.type` CHECK + its sign convention (ADR 009)              |
