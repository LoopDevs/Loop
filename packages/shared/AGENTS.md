...
| `src/me-wallet.ts`                     | ADR 030 Phase C embedded-wallet shapes — `MeWalletResponse` (`GET /api/me/wallet`), `WalletProvisioningState`, `PayWithBalanceResponse` (`POST /api/orders/loop/:id/pay-with-balance`)      |
