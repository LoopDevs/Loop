# 2026-05-03 Claude Cold Audit

This directory is the execution cockpit for the 2026-05-03 cold audit of Loop.

Isolation rule:

This directory is Claude's independent audit workspace. Ignore `docs/audit-2026-05-03/**` entirely during execution: do not read it for evidence, do not use its findings, do not compare against its tracker, and do not include it in file-disposition coverage. If both audits discover the same issue, Claude must still capture its own evidence and file it independently in this directory.
...
- In-scope tracked files at scaffold start: 1,222
- Workspace file inventory after scaffold refresh, excluding dependency/build output: 1,197
- Claude audit scaffold files requiring self-review: 68
