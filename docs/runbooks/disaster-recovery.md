...
| **`merchant_cashback_configs`, `ctx_catalog_snapshots`, merchant catalog cache**                                                     | No — CTX is the source; Loop's copy is a cache (hourly sweep + live ws maintenance).                                                                                                                                                                                                                                                                       | Rebuilds automatically on next sync tick. No backup needed for this class.                                                                                                                                                                                                                                                                                    |
