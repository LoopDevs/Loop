...
Status: Accepted (operator-pool section superseded by ADR 051 —
Loop now authenticates with its single company API key; the
Loop-owned-auth half of this ADR stands)
Date: 2026-04-21
