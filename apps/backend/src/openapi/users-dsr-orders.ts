...
export function registerUsersDsrOrdersOpenApi(
  ...
  registry.registerPath({
    ...
    responses: {
      ...
      409: {
        description:
          'Pre-condition failed: pending payout, in-flight order, failed legacy withdrawal awaiting compensation (A4-078), or a non-zero cashback balance (PLAT-30-03)',
        content: { 'application/json': { schema: errorResponse } },
      },
      429: {
