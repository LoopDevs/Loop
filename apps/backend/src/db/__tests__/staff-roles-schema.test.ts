/**
 * ADR 037 / migration 0039: the `staff_roles` table mirror plus the
...
describe('staff_roles table (ADR 037 / migration 0039)', () => {
...
describe('ADR 037 reverse-lookup indexes (migration 0039)', () => {
