...
/**
 * ADR 030 Phase B / migration 0039: `users.wallet_provider` +
 ...
 */
describe('users wallet columns (ADR 030 Phase B / migration 0039)', () => {
...
/**
 * ADR 030 Phase C / migration 0040: the wallet-provisioning state
 * machine columns. Same drift-pinning rationale as the Phase-B block
 * above.
 */
describe('users wallet-provisioning columns (ADR 030 Phase C / migration 0040)', () => {
