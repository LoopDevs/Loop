...
// so the real deposit-rail read would fail CLOSED and halt the watcher tick.
// Treat the rail as OPEN; the DB-backed enforcement is proven in the
// rail-kill-switches integration suite.
