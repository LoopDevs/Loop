 ...
 * malicious payloads in every exported report. Every CSV exporter
 * routes through here (the admin ones via `admin/csv-escape.ts`, for
 * call-site stability). One source of truth, because the reader is
 * finance or legal opening the file in an elevated-privilege
 * spreadsheet context.
 */
