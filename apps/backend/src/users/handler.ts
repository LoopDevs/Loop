 ...
 * for the `/settings/cashback` page header ("£42 lifetime · £3.20
 * this month"). Avoids shipping the whole ledger when the UI only
 * wants totals.
 *
 ...
 * current `home_currency`; we don't cross-currency-sum. Users who
 * have moved regions (rare, support-mediated) see only home-currency
