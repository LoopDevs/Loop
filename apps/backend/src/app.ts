...
// Daily orders sparkline — dense day-by-day fulfilled counts,
// sums. Companion to cashback-activity so the two trend lines
// read side-by-side on the admin dashboard.
