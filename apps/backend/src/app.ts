...
import { adminListOrdersHandler, adminOrdersSummaryHandler } from './admin/orders.js';
import {
...
// Orders summary chip strip — single GROUP BY, one round-trip.
app.get('/api/admin/orders/summary', rateLimit(60, 60_000), adminOrdersSummaryHandler);
