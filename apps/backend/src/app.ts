...
import { adminRefundOrderHandler } from './admin/refund.js';
import {
...
// Refund a failed order (ADR 009 / 011). Idempotent — second hit
// on the same order returns 409 rather than double-paying.
app.post('/api/admin/orders/:orderId/refund', rateLimit(20, 60_000), adminRefundOrderHandler);
