      ...
      <div className="text-white relative overflow-hidden">
        ...
        <div className="relative z-0 text-center pt-32 pb-16 px-6 lg:pt-48 lg:pb-24">
          ...
          <div className="flex flex-row justify-center items-center gap-8 md:gap-16 mt-12 mb-12">
            <Feature icon="⚡" label="Instant Delivery" />
            <Feature icon="📍" label="100,000+ Locations" />
            <Feature icon="💰" label="Save up to 25%" />
          </div>
        </div>
...
function Feature({ icon, label }: { icon: string; label: string }): React.JSX.Element {
  return (
