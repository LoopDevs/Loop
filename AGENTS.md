...
6. **Rate limiting** — per-IP: `/api/clusters` (60/min), `/api/image` (300/min), `/api/merchants` (180/min, A2-650), `/api/merchants/all` (60/min, A2-650), `/api/merchants/by-slug/:slug` (120/min, A2-650), `/api/merchants/cashback-rates` (120/min), `/api/merchants/:id/cashback-rate` (120/min), `/api/auth/request-otp` (5/min), `/api/auth/verify-otp` (10/min), `/api/auth/refresh` (30/min), `DELETE /api/auth/session` (20/min), `POST /api/orders` (10/min), `GET /api/orders` (60/min), `GET /api/orders/:id` (120/min). 429 responses include `Retry-After`.
