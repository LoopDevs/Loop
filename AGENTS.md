...
| `docs/audit-2026-05-03-claude/tracker.md`                   | **Active audit tracker** (2026-05-03 isolated re-audit; 71 findings + remediation states). `docs/audit-2026-tracker.md` (2026-04, 467 findings) is superseded per its own A4-068 banner; the pre-2026 trio (`codebase-audit.md` / `audit-checklist.md` / `audit-tracker.md`) is historical only. |
