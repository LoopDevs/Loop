...
- Create a feature branch, push, open a PR. CI runs eight jobs: `quality`, `test-unit`, `audit`, `secret-scan` (gitleaks, A2-206), `build`, `test-e2e-mocked`, `test-e2e` (PR only), and `notify`.
